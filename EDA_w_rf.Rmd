...
predict(poisson2.home.score, newdata = train.Home.score)
...
predict(poisson2.visitor.score, newdata = test.Visitor.score)
...
for(mtry in 1:18) {
  rf=randomForest(Home.Score ~ ., train.Home.score[, c(3:20, 40, 47)], type = "regression", mtry=mtry, ntree=400) 
  oob.err[mtry] = rf$mse[400] #Error of all Trees fitted
  
  pred<-predict(rf, test.Home.score[, c(3:20, 40, 47)]) #Predictions on Test Set for each Tree
  test.err[mtry]= with(test.Home.score[, c(3:20, 40, 47)], mean( (Home.Score - pred)^2)) #Mean Squared Test Error

...
lm1.Home.score <- lm(Home.Score ~ ., data = train.score[, c(1, 3:20, 40, 42, 43)])
step(lm1.Home.score, trace = 0)
lm2.Home.score <- lm(Home.Score ~ Home_PassAtt + Home_PassTD + Home_RushYds + Home_RushTD + Home_XPA + Home_FGM + Home_FGPercent + Home.O.Rank, data = train.score[, c(1, 3:20, 40, 42, 43)])
